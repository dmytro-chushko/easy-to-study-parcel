...
export default function onClickMenuButton() {
  Object.values(refsSidebar)
    .filter(value => value !== refsSidebar.sidebar)
    .forEach(ref => ref.addEventListener('click', toggleHiddenClass));
};